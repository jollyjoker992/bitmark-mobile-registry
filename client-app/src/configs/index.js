...
let config = {
  ...
  ifttt_invite_url:
    'https://ifttt.com/features/redeem?code=10403-fa99108249f426f459a2e1033ddfbbb5',
...
if (config.network === NETWORKS.testnet) {
  ...
  config.ifttt_invite_url =
    'https://ifttt.com/features/redeem?code=10518-3f2950b543e7a5a2dc307de0c05775e4';
  config.ifttt_bitmark_service_url = 'https://ifttt.com/bitmarktest';
  config.ifttt_bitmark_service_settings_url =
    'https://ifttt.com/services/bitmarktest/settings';
  ...
  config.ifttt_invite_url =
    'https://ifttt.com/features/redeem?code=9187-5ba0e766190b2d174a5a3708fe2002ae';
  config.ifttt_bitmark_service_url = 'https://ifttt.com/bitmark';
  config.ifttt_bitmark_service_settings_url =
    'https://ifttt.com/services/bitmark/settings';
