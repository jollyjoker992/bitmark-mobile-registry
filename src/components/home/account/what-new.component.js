...
const styles = StyleSheet.create({
  ...
  body: {
    paddingTop: (iosConfig.isIPhoneX ? iosConstant.headerSize.paddingTop : 0),
    flex: 1,
  },
  bodyContent: {
    flex: 1,
  ...
  newContentSwipePage: {
    flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center',
    paddingTop: iosConfig.isIPhoneX ? 45 : 25, paddingBottom: iosConfig.isIPhoneX ? 45 : 25,
  },
  newSwipeImage: {
  ...
  swipePagination: {
    position: 'absolute', bottom: iosConfig.isIPhoneX ? 3 : 18,
  },
  skipButton: {
